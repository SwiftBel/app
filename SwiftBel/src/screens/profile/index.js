...
const App = () => {
  ...
  const [routes] = useState([
    ...
    {key: 'tab2', title: 'Language'},
    {key: 'tab3', title: 'Reviews'},
    {key: 'tab4', title: 'About'},
  ]);
      ...
      <Animated.View
        ...
        style={[styles.header, {transform: [{translateY: y}]}]}>
          <MainHeader
            ...
            RightImage={Etc}
            />
            <TouchableOpacity style={Style.bannerContainer}>
            <Image
            source={backPicture}
            resizeMode='cover'
            ...
            <View style={Style.informationContainer}> 
                <Text style={Style.InformationTextStyle}>45Rating</Text>
                <Text style={Style.InformationTextStyle}>45Likes</Text>
                <Text style={Style.InformationTextStyle}>45Reviews</Text>
            </View>
            <View style={{alignItems:'center'}}>
            <TouchableOpacity style={[Style.newPostButton]} onPress={()=>{
                ImagePicker.openCropper({
                    path: 'https://myawsbucket-swiftbel.s3.ca-central-1.amazonaws.com/test1/1649827692112i.png',
                    width: 300,
                    height: 400,
    ...
    return (
      <Animated.FlatList
        ...
        contentContainerStyle={{
          paddingTop: HeaderHeight + TabBarHeight+20,
